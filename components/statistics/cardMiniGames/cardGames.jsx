...
const СardGames = ({ savannah,speakit,sprint, audiocall, hangman, puzzle }) => {
  ...
  const data2 = {
    ...
    datasets: [
      {
        data: (amountWords.length? [...amountWords] : amountWords),
