    ...
    const updateAppState = () => {
      ...
      getSettings()
        .then((response) => {
          ...
          setLearnProgress({
            ...learnProgress,
            total: response.data.optional ? response.data.optional.amountOfCards : cardSettings.amountOfCards,
          })

          // FETCH WORDS LOGIC
          const amountOfCards = response.data.optional
            ? response.data.optional.amountOfCards
            : cardSettings.amountOfCards
          const level = response.data.optional ? response.data.optional.level : cardSettings.level
          const difficultOnly = response.data.optional
            ? response.data.optional.difficultOnly
            : cardSettings.difficultOnly
